 ...
 * @author rafae
 */
public class ManutencaoLivros extends javax.swing.JFrame {

    /**
     * Creates new form ManutencaoLivros
     */
    public ManutencaoLivros() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManutencaoLivros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManutencaoLivros().setVisible(true);
            }
        });
    }
